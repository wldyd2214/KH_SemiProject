...
/**
 * Servlet implementation class SelectNuriEndedListServlet
 */
@WebServlet("/selectNuriEndedList.nu")
public class SelectNuriEndedListServlet extends HttpServlet {
     ...
     */
    public SelectNuriEndedListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
				...
				ArrayList<Nuriter> list = new NuriterService().selectEndList(currentPage, limit, userNum);
				System.out.println("개설 중인 누리터 리스트 : " + list);

				String page = "";

				if (list != null) {
					page = "/views/common/nuriEnded.jsp";
