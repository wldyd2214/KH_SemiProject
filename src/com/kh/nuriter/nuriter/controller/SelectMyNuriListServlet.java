...
/**
 * Servlet implementation class SelectMyNuriListServlet
 */
@WebServlet("/selectMyNuriList.nu")
public class SelectMyNuriListServlet extends HttpServlet {
     ...
     */
    public SelectMyNuriListServlet() {
        super();
