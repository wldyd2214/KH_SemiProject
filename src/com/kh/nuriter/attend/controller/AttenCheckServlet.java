...
/**
 * Servlet implementation class AttenCheckServlet
 */
@WebServlet("/attencheck.nu")
public class AttenCheckServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AttenCheckServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// 페이징처리 추가
				...
				ArrayList<Nuriter> list1 = new NuriterService().selectMyNuriList1(currentPage, limit, userNum);
				System.out.println("참여중인 누리터 리스트: " +list1);
