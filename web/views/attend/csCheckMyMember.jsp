...
<%-- <%@ include file="../common/logoAndLogbutton.jsp" %> --%>
   ...
   <div id=#main>
   <h2 style="margin-top:7%; margin-left:20%;">출석정보확인</h2> 
...
<td height="60" style="border:1px solid #FFFFFF">
       ...
       <tr>
             <td height="10">
             <div style="font-size:30px;"><%=nickName%>님의 출석정보입니다.</div>
             </td>
       </tr>      
       <tr>
             <td align="center" >
...
<input type="button" value="이전페이지로" onclick="location.href='<%=request.getContextPath()%>/selectMyNuriMember.at?nuriNum=<%=nunum%>'">
</div>	
